...
| run.py | Python | Test that guess must be a letter or word | Input is validated then displayed with error message and reprompt for input |![screenshot](readme-images/validation-wrong-word.png)
| run.py | Python | Test word guess is correct | Input is tested then displayed with message showing that guess is incorrect and reprompt for input|![screenshot](readme-images/validation-not-a-letter.png)
